    ...
    <VCard>
      <VCardText class="d-flex flex-wrap py-4 gap-4">
        ...
        <div class="app-user-search-filter d-flex align-center flex-wrap gap-4">
          <router-link
            :to="
              '/conference/manageConferenceMediaPartner/add/' + this.paramsId
            "
          >
            <VBtn prepend-icon="tabler-plus">
              Add Conference Media Partner
            </VBtn>
          </router-link>
        </div>
      </VCardText>
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      http
        .post(
          "/conference-media-partner/index",
          { id: this.id },
          +"?page=" +
            this.options.page +
            "&itemsPerPage=" +
    ...
    deleteData() {
      http
        .post("/conference-media-partner/delete", {
