        ...
        <v-data-table class="text-no-wrap" fixed-header>
          <thead>
            <tr>
              ...
              <th class="text-uppercase text-center">City</th>
              <th class="text-uppercase text-center">Organization</th>
              <th class="text-uppercase text-center">Country Name</th>
              <th class="text-uppercase text-center">Interested In</th>
              <th class="text-uppercase text-center">Abstract Title</th>
              <th class="text-uppercase text-center">Message</th>
              <th class="text-uppercase text-center">Submit Abstract File</th>
            </tr>
          </thead>
          ...
          <tbody>
            <tr v-for="(item, index) in data.data" :key="index">
              ...
              <td class="text-center">
                <a :href="item.submit_abstract_file" target="_blank" download
                  >Download</a
                >
              </td>
            </tr>
