                ...
                <v-data-table class="text-no-wrap" fixed-header>
                    <thead>
                        <tr>
                            ...
                            <th class="text-uppercase text-center">Demo Status</th>
                    ...
                    <tbody>
                        <tr v-for="(item, index) in data.data" :key="index">
                            ...
                            <td class="text-center">
                                {{ item.demo_status == 1 ? "Finished" : "Pending" }}
                            </td>
                            <td class="text-center">
                                <router-link :to="'/demo/editDemo/' + item.id">
                                    <IconBtn>
...
export default {
    ...
    methods: {
        ...
        deleteData() {
            http
                .post("/booking-demo/delete/" + this.editableId, {})
                .then((res) => {
                    if (res.data.success) {
                        this.fetchData();
