      ...
      <VCardText class="d-flex flex-wrap py-4 gap-4">
        ...
        <div class="app-user-search-filter d-flex align-center flex-wrap gap-4">
          ...
          <div style="inline-size: 10rem">
            <AppTextField v-model="options.search" placeholder="Search" density="compact" @keyup="fetchData()" />
          </div>
        </div>
        <div class="app-user-search-filter d-flex align-center flex-wrap gap-4">
        ...
        <v-data-table class="text-no-wrap" fixed-header>
          <thead>
            <tr>
              ...
              <th class="text-uppercase text-center">Subscription Date</th>
              <th class="text-uppercase text-center">Subscription End Date Date</th>
...
export default {
  ...
  methods: {
    ...
    deleteData() {
      http
        .post("/user/delete/" + this.editableId, {})
        .then((res) => {
          if (res.data.success) {
            this.fetchData();
