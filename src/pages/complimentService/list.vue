    ...
    <div>
        ...
        <VCard>
            <VCardText class="d-flex flex-wrap py-4 gap-4">
                ...
                <div class="app-user-search-filter d-flex align-center flex-wrap gap-4">
                    <router-link to="/complimentService/add">
                        <VBtn prepend-icon="tabler-plus"> Add Compliment Service </VBtn>
                    </router-link>
                </div>
            </VCardText>
            <VDivider />
                ...
                <v-data-table class="text-no-wrap" fixed-header>
                    ...
                    <tbody>
                        <tr v-for="(item, index) in data.data" :key="index">
                            ...
                            <td class="text-center">
                                <router-link :to="'/complimentService/editComplimentService/' + item.id">
                                    <IconBtn>
...
export default {
    ...
    methods: {
        ...
        deleteData() {
            http
                .post("/compliment-service/delete/" + this.editableId, {})
                .then((res) => {
                    if (res.data.success) {
                        this.fetchData();
