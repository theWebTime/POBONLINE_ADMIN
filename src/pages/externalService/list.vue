    ...
    <div>
      ...
      <VCard>
        <VCardText class="d-flex flex-wrap py-4 gap-4">
          ...
          <div class="app-user-search-filter d-flex align-center flex-wrap gap-4">
          <router-link to="/externalService/add">
          ...
          <v-data-table class="text-no-wrap" fixed-header>
            <thead>
              <tr>
                ...
                <th class="text-uppercase text-center">Service Price</th>
            ...
            <tbody>
              <tr v-for="(item, index) in data.data" :key="index">
                ...
                <td class="text-center">
                  <router-link :to="'/externalService/editExternalService/' + item.id">
                    <IconBtn>
...
import http from "../../http-common";
  export default {
    ...
    methods: {
      ...
      deleteData() {
        http
          .post("/external-service/delete/" + this.editableId, {})
          .then((res) => {
            if (res.data.success) {
              this.fetchData();
